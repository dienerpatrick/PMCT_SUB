...
# parts of code based on pytorch tutorial https://pytorch.org/tutorials/beginner/basics/optimization_tutorial.html
# and https://github.com/christianversloot/machine-learning-articles/blob/main/how-to-use-k-fold-cross-validation-with-pytorch.md
